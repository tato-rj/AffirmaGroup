    ...
    <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-center px-4">
            ...
            <div class="d-flex justify-content-center">
                <div><a href="{{route('ebook.download', ['ext' => 'pdf'])}}" class="btn btn-outline-primary mx-2">PDF</a></div>
                <div><a href="{{route('ebook.download', ['ext' => 'epub'])}}" class="btn btn-outline-primary mx-2">EPUB</a></div>
            </div>
        </div>
    </div>
</section>
